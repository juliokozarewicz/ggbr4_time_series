...
class Stationarity_diff:
    ...
    def adf_teste(self):
        ...
        with open('2_results/7_adf_test_level.txt', 'w') as desc_stat:
    ...
    def diff_data(self):
        ...
        while True:
            ...
            if adf_p_value > self.p_value_accepted:
                ...
                with open('2_results/8_adf_diff_result.txt', 'w') as desc_stat:
    ...
    def independent_var_stationarity(self):
        ...
        self.data_all.to_csv("1_data/2_stationary.csv")
